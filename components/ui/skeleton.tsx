...
export function SkeletonHeaderBox() {
  return (
...
export function HeaderBox() {
  return (
    <div className="flex flex-col gap-1">
      <Skeleton className="h-[40px] w-[350px] rounded-xl bg-gray-200" />
      <Skeleton className="h-[24px] w-[650px] rounded-xl bg-gray-200" />
    </div>
  );
}

export function TotalBalanceBox() {
  return <Skeleton className="h-[170px] w-[650px] rounded-xl bg-gray-200" />;
}
